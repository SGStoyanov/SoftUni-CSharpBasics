...
a crash.
Rocks are the symbols ^, @, *, &, +, %, $, #, !, ., ;, - distributed with appropriate density. The dwarf is (O). Ensure 
a constant game speed by Thread.Sleep(150).
...
class FallingRocks
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            fallingRocks();
            printScore();
            Thread.Sleep(150); // Requirement of the homework problem.
            Console.Clear();
        }
    }
}
